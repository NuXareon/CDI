## dic14_wavelets : includes haar, daub4 and daub6
## SXD 521
...
def daub4_matrix(N):  # for vectors of length N
    ...
    D = zeros([N,N])
    for i in range(N//2):
        D[2*i,2*i] = a1; D[2*i,2*i+1] = a2 
        D[2*i,(2*i+2)%N] = a3; D[2*i,(2*i+3)%N] = a4
        D[2*i+1,2*i] = b1; D[2*i+1,2*i+1] = b2 
        D[2*i+1,(2*i+2)%N] = b3; D[2*i+1,(2*i+3)%N] = b4
    return matrix(D)
...
def daub6_matrix(N):  # for vectors of length N
    ...
    for i in range(N//2):
        D[2*i,2*i] = a1; D[2*i,2*i+1] = a2 
        D[2*i,(2*i+2)%N] = a3; D[2*i,(2*i+3)%N] = a4
        D[2*i,(2*i+4)%N] = a5; D[2*i,(2*i+5)%N] = a6
        D[2*i+1,2*i] = b1; D[2*i+1,2*i+1] = b2 
        D[2*i+1,(2*i+2)%N] = b3; D[2*i+1,(2*i+3)%N] = b4
        D[2*i+1,(2*i+4)%N] = b5; D[2*i+1,(2*i+5)%N] = b6
    return matrix(D)
